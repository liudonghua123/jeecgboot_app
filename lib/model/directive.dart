...
class Directive {
  ...
  /// 创建日期,timezone = "GMT+8",pattern = "yyyy-MM-dd HH:mm:ss"
  final DateTime createTime;
  /// 更新人
  final String updateBy;
  /// 更新日期,timezone = "GMT+8",pattern = "yyyy-MM-dd HH:mm:ss"
  ...
  factory Directive.fromJson(Map<String, dynamic> json) => _$DirectiveFromJson(json);
